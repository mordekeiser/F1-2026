// F1 API utilities — fetches from Jolpica (Ergast mirror) which is free & no key needed
// All data is REAL and live — standings update after every race weekend
...
export function getTeamColor(name: string): string {
  const map: Record<string, string> = {
    ...
    "Red Bull": "#3671C6", Williams: "#64C4FF", "Haas F1 Team": "#B6BABD",
    "Alpine F1 Team": "#0093CC", "Aston Martin": "#358C75",
    Audi: "#D0D0D0", "RB F1 Team": "#6692FF", "Cadillac Racing": "#FF6900",
  };
...
export function getNationality(nat: string): string {
  const map: Record<string, string> = {
    Italian: "🇮🇹", British: "🇬🇧", Monegasque: "🇲🇨", Dutch: "🇳🇱",
    Australian: "🇦🇺", Spanish: "🇪🇸", French: "🇫🇷", Mexican: "🇲🇽",
    Canadian: "🇨🇦", Finnish: "🇫🇮", German: "🇩🇪", Thai: "🇹🇭",
    Argentine: "🇦🇷", "New Zealander": "🇳🇿", Brazilian: "🇧🇷", American: "🇺🇸",
  };
  return map[nat] ?? "🏁";
}
