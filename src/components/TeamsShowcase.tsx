    ...
    <section id="teams" className="bg-[#0d0d0d] py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-10">
          ...
          <p className="text-zinc-500 text-sm mt-1">11 constructors · including 2 new entries</p>
        </div>
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    {team.isNew && (
                      <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: `${team.color}25`, color: team.color }}>
                        NEW 2026
                      </span>
                    )}
                  </div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-zinc-300 text-right text-xs">{team.base}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-zinc-500">Principal</span>
                    <span className="text-zinc-300 text-xs">{team.principal}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-zinc-500">Engine</span>
                    <span className="text-zinc-300 text-xs">{team.engine}</span>
                  </div>
                </div>
                ...
                <div className="h-0.5 mt-5 rounded-full opacity-40" style={{ background: team.color }} />
              </div>
            </motion.div>
          ))}
        </div>
